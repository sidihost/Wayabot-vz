    ...
    <footer className="border-t border-border/40 bg-muted/30">
      <div className="container mx-auto px-4 py-12">
        <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-5">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="mb-4 max-w-sm text-sm text-muted-foreground">
              The ultimate AI-powered platform to create intelligent Telegram bots. 
              Build, deploy, and manage bots with natural language.
            </p>
        ...
        <div className="mt-12 flex flex-col items-center justify-between gap-4 border-t border-border/40 pt-8 text-sm text-muted-foreground sm:flex-row">
          <p>2026 Waya. All rights reserved.</p>
